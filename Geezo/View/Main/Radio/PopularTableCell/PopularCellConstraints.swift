...
final class PopularCellConstraints: UIView {
    ...
    public func addConstraintsToLabels(_ labelsView: UIView, view: UITableViewCell) {
        labelsView.translatesAutoresizingMaskIntoConstraints = false
        
        labelsView.centerYAnchor.constraint(equalTo: view.centerYAnchor).isActive = true
        labelsView.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 16.0).isActive = true
        labelsView.widthAnchor.constraint(equalToConstant: 210.0).isActive = true
        labelsView.heightAnchor.constraint(equalToConstant: 55.0).isActive = true
    }
    ...
    public func addConstraintsToText(_ textLabel: UILabel, view: UIView, parent: AnyObject) {
        ...
        textLabel.topAnchor.constraint(equalTo: parent.bottomAnchor, constant: 8.0).isActive = true
